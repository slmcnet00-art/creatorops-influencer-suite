...
function buildDataRoomExtendedRawCatalog({ rawData, backendConfig, creators, outreach, contentReferences, creatorGroups = [] }) {
  ...
  return append([
    ...
    },
    {
      ...
      opsOwner: 'Brand Analyst',
      techOwner: 'Data Engineer',
      qualityIssue: '외부 보고서 기준 수치이므로 수집일, 원천 서비스, 채널 URL 중복, 예상 단가 산식 버전을 같이 보존해야 함',
      logLocation: 'future: external_report_import_logs',
      note: '확인 컬럼: Influencers, Channel link, Subscribers, Region, Language, Average views, Total Views, Engagement rate, Videos, The last video, Price',
      active: true,
    },
    {
      ...
      scope: '외부',
      category: '콘텐츠 모니터링',
      description: 'Video Monitor Data에서 내려받은 프로젝트 요약, 콘텐츠별 상세 성과, 일별 변화 데이터',
      purpose: '광고주 캠페인 콘텐츠의 조회수/좋아요/댓글/공유/저장/전환/비용 지표와 일별 누적 변화를 추적',
      method: '수동 업로드 / 외부 리포트',
      cycle: '리포트 업로드 시 / 일별 갱신',
      lastCollectedAt: '-',
      nextCollectAt: '외부 리포트 업로드 시',
      status: '미수집',
      ...
      opsOwner: 'Report Operator',
      techOwner: 'Data Engineer',
      qualityIssue: '플랫폼별 공개 지표 누락, 수동 업로드 시 날짜/프로젝트명/콘텐츠 URL 매칭 오류를 검증해야 함',
      logLocation: 'future: external_report_import_logs / report_metric_snapshots',
      note: '확인 컬럼: Project, Platform, KOL Channel, URL, Followers, Views, Comments, Likes, Shares, collects, ER, CPM/CPE/CPC/ROAS/ROI, Est. Video Value',
      active: true,
    },
    {
